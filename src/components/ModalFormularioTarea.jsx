...
const ModalFormularioTarea = () => {
    ...
    const { modalFormularioTarea, handleModalTarea, mostrarAlerta, alerta, submitTarea, proyectos, tarea, } = useProyectos();

    useEffect(() => {
        //esto sirve para evitar que la consola arroje error diciendo que va de un componente controlado a uno no controlado(porque el modal se usa tanto para crear tarea como para editar y el error surge cuando click en nueva tarea, cierro y luego click en editar tarea)
        if (tarea?._id){
            setId(tarea._id)
                                    ...
                                    >
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <input
                                                ...
                                                className="flex border-2 rounded-lg w-full p-2 mt-2 placeholder-gray-400"
                                                value={nombre}
