                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-red-600">
                                            Eliminar colaborador
                                    </Dialog.Title>

                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500 font-bold'>Una vez eliminado, el colaborador no podrá acceder al proyecto</p>
                                    </div>
                                </div>
                            </div>
